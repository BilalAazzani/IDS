...
*/
                if((int)ip->ip_p==UDP_PROTOCOL)
                {
                        ...
                        size_udp = (u_int) udp->udp_len;

                        payload = (u_char*) (packet + SIZE_ETHERNET + size_ip + size_udp);
                        
                        custom_udp_packet.source_port = ntohs(udp->udp_sport);
                        custom_udp_packet.destination_port = ntohs(udp->udp_dport);
                        custom_udp_packet.data = payload;
                        
                        strcpy(custom_packet.transport_protocol,"udp");
                ...
                if((int)ip->ip_p==TCP_PROTOCOL)
                {
                        ...
                        strcpy(custom_packet.transport_protocol,"tcp");
